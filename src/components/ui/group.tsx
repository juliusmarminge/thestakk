...
const groupVariants = cva(
  "flex w-fit *:focus-visible:z-10 *:has-focus-visible:z-10 has-[>[data-slot=group]]:gap-2",
  {
    variants: {
      orientation: {
        horizontal:
          "*:not-first:rounded-s-none *:not-first:border-s-0 *:not-nth-last-[1_of_:not([aria-hidden],span[data-base-ui-inert])]:rounded-e-none *:not-nth-last-[1_of_:not([aria-hidden],span[data-base-ui-inert])]:border-e-0 *:not-first:before:-start-[0.5px] *:not-first:before:rounded-s-none *:not-nth-last-[1_of_:not([aria-hidden],span[data-base-ui-inert])]:before:-end-[0.5px] *:not-nth-last-[1_of_:not([aria-hidden],span[data-base-ui-inert])]:before:rounded-e-none *:pointer-coarse:after:min-w-auto",
        vertical:
          "flex-col *:not-first:rounded-t-none *:not-first:border-t-0 *:not-nth-last-[1_of_:not([aria-hidden],span[data-base-ui-inert])]:rounded-b-none *:not-nth-last-[1_of_:not([aria-hidden],span[data-base-ui-inert])]:border-b-0 *:not-first:before:-top-[0.5px] *:not-first:before:rounded-t-none *:not-nth-last-[1_of_:not([aria-hidden],span[data-base-ui-inert])]:before:-bottom-[0.5px] *:not-nth-last-[1_of_:not([aria-hidden],span[data-base-ui-inert])]:before:hidden *:not-nth-last-[1_of_:not([aria-hidden],span[data-base-ui-inert])]:before:rounded-b-none dark:*:first:before:block dark:*:last:before:hidden *:pointer-coarse:after:min-h-auto",
      },
    },
    defaultVariants: {
